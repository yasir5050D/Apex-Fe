        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:block ms-4">
              <Button className="hover:opacity-90 bg-indigo-600 text-white" onClick={onGetStarted}>
                Enroll Now
              </Button>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-white hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <Button onClick={onGetStarted} className="w-full bg-indigo-600 text-white">
                  Enroll Now
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <Button className="w-full" style={{ backgroundColor: '#0057A3' }}>
                  Enroll Now
                </Button>
              </CardContent>
            </Card>
